    ...
    <div class="flex justify-between h-16">
      ...
      <div class="shrink-0 flex items-center">
        <a href="{{ route('home') }}" class="flex items-center space-x-2">
          <img src="{{ asset('images/logo.png') }}" alt="{{ config('app.name') }}" style="height:32px;"/>
      ...
      <div class="hidden space-x-8 sm:flex sm:ms-10">
        ...
        <x-nav-link :href="route('checkout')" :active="request()->routeIs('checkout')">Contratar</x-nav-link>
        <x-nav-link :href="route('about')"   :active="request()->routeIs('about')">Acerca de</x-nav-link>
